...
function UserAndJobState(url, auth, auth_cb) {
    ...
    this.share_job = function (job, arg_2, _callback, _errorCallback) {
    return json_call_ajax("UserAndJobState.share_job",
        [job, arg_2], 0, _callback, _errorCallback);
};

    this.share_job_async = function (job, arg_2, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("UserAndJobState.share_job", [job, arg_2], 0, _callback, _error_callback);
    };

    this.unshare_job = function (job, arg_2, _callback, _errorCallback) {
    return json_call_ajax("UserAndJobState.unshare_job",
        [job, arg_2], 0, _callback, _errorCallback);
};

    this.unshare_job_async = function (job, arg_2, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("UserAndJobState.unshare_job", [job, arg_2], 0, _callback, _error_callback);
    };
