...
function UserAndJobState(url, auth, auth_cb) {
    ...
    this.list_job_services = function (auth, _callback, _errorCallback) {
    return json_call_ajax("UserAndJobState.list_job_services",
        [auth], 1, _callback, _errorCallback);
};

    this.list_job_services_async = function (auth, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("UserAndJobState.list_job_services", [auth], 1, _callback, _error_callback);
    };
