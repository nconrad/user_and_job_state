...
function UserAndJobState(url, auth, auth_cb) {
    ...
    this.list_jobs = function (service, filter, _callback, _errorCallback) {
    return json_call_ajax("UserAndJobState.list_jobs",
        [service, filter], 1, _callback, _errorCallback);
};

    this.list_jobs_async = function (service, filter, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("UserAndJobState.list_jobs", [service, filter], 1, _callback, _error_callback);
    };
