 ...
 *
 */
public class AweHttpException extends AweException {
	 ...
	 */
	public AweHttpException(int code) { 
		super();
		this.code = code;
	}
	 ...
	 */
	public AweHttpException(int code, String message) {
		super(message);
		this.code = code;
	}
	 ...
	 * @param cause the exception that caused this exception. Rarely used.
	 */
	public AweHttpException(int code, Throwable cause) {
		super(cause);
		this.code = code;
	}
